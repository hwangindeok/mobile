...
public class AuthActivity extends Activity {
	...
	public void getParam(){
	    ...
	    beforeuserno = resultIntent.getStringExtra("userno");
  	 ...
  	 LinearLayout.LayoutParams  _linearLayout  = new LinearLayout.LayoutParams(
        ...
        yDAuthView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.setType("*/*");
                AuthActivity.this.startActivityForResult(Intent.createChooser(i, "File Chooser"),FILECHOOSER_RESULTCODE);
            }
        ...
        yDAuthView.loadUrl("https://m.ncucu.com/auth/?gameid="+gameid+"&userno="+beforeuserno);
        //yDAuthView.loadUrl("http://m.naver.com");
        //DAuthView.loadData("", "text/html", null);
        //yDAuthView.loadUrl("javascript:alert(injectedObject.toString())");
        //yDAuthView.loadUrl("file:///android_asset/sample.html");
	...
	@JavascriptInterface 
	 public void setUserInfo(String userid , String userno) {
